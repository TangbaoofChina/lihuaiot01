...
<div class="panel panel-default">
    <div class="panel-body">
        ...
        <div class="columns-right" id="hisLhrj0bp1DeviceListDiv" style="white-space: nowrap;display: none">
            <div id="hisLhrj0bp1toolbar" class="btn-group">
                <div class="form-inline">
                    <label>时间：</label>
                    <div class="btn-group">
                        <input type="text" id="hisLhrj0bp1DateInterval" class="form-control" style="width: 320px;">
                    </div>
                    <button class="btn btn-default" id="hisLhrj0bp1Query_storage">
                        <span class="glyphicon glyphicon-search" aria-hidden="true"></span>查询
                    </button>
                    <button class="btn btn-default" id="hisLhrj0bp1Export_storage">
                        <span class="glyphicon glyphicon-export" aria-hidden="true"></span>导出
                    </button>
                </div>
            </div>
            ...
            <div class="col-md-9 col-sm-8">
                <table class="table table-striped" id="hisLhrj0bp1DeviceList" align="center"
                       striped="true" data-click-to-select="true"
                       data-toolbar="#hisLhrj0bp1toolbar"<%--设置装按钮的容器为id为toolbar--%>
                       data-pagination="true"<%--设置是否显示页码数--%>
                       data-show-refresh="true" <%--设置刷新按钮--%>
                       data-show-toggle="true" <%--设置数据显示格式--%>
                       data-showColumns="true">
        ...
        <div class="columns-right" id="hisLhslzlp1DeviceListDiv" style="white-space: nowrap;display: none">
            <div id="hisLhslzlp1toolbar" class="btn-group">
                <div class="form-inline">
                    <label>时间：</label>
                    <div class="btn-group">
                        <input type="text" id="hisLhslzlp1DateInterval" class="form-control" style="width: 320px;">
                    </div>
                    <button class="btn btn-default" id="hisLhslzlp1Query_storage">
                        <span class="glyphicon glyphicon-search" aria-hidden="true"></span>查询
                    </button>
                    <button class="btn btn-default" id="hisLhslzlp1Export_storage">
                        <span class="glyphicon glyphicon-export" aria-hidden="true"></span>导出
                    </button>
                </div>
            </div>
            ...
            <div class="col-md-9 col-sm-8">
                <table class="table table-striped" id="hisLhslzlp1DeviceList" align="center"
                       striped="true" data-click-to-select="true"
                       data-toolbar="#hisLhslzlp1toolbar"<%--设置装按钮的容器为id为toolbar--%>
                       data-pagination="true"<%--设置是否显示页码数--%>
                       data-show-refresh="true" <%--设置刷新按钮--%>
                       data-show-toggle="true" <%--设置数据显示格式--%>
                       data-showColumns="true">
