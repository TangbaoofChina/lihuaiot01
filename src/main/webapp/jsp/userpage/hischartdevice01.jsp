...
<div class="panel panel-default" style="height:100%;width:100%;">
    ...
    <div class="panel-body" style="height:100%;width:100%;">
        ...
        <%--立华食品-冷库测温第一部分--%>
       <div class="columns-right" id="hisChartLhsp05p1DivP1" style="display: none;white-space: nowrap;">
           <div class="form-inline" style="display: block;">
               <div class="input-group" id="hisChartLhsp05p1Param">
                   <label>参数：</label>
                   <select name="hisChartLhsp05p1SelName_Param" onchange="hisChartLhsp05p1ParamChange()"
                           id="hisChartLhsp05p1SelId_Param"
                           class="input-sm">
               ...
               <label>时间：</label>
               <div class="btn-group">
                   <input type="text" id="hisChartLhsp05p1DateInterval" class="form-control" style="width: 320px;">
               </div>
               <button class="btn btn-default" id="hisChartLhsp05p1Query_storage" onclick="hisChartLhsp05p1Query()">
                   <span class="glyphicon glyphicon-search" aria-hidden="true"></span>查询
               </button>
           </div>
       </div>
