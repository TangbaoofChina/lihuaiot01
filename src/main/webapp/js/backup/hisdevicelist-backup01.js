...
var hisSetting = {
    ...
    callback: {
        beforeClick: function (treeId, treeNode) {
            ...
            hisNextNode = treeNode.getNextNode();
            hisParentNode = treeNode.getParentNode();
            hisNowTreeNode = treeNode;
            hisTreeNodeHighLightClear();
...
function hisFindZTreeNode(txtSearch) {
    $.ajax({
...
// 要传递的数据
        ...
        success: function (result) {
            if (JSON.stringify(result) !== '[]') {
                ...
                hisTreeNodes = json;
                $.fn.zTree.init($("#tree"), hisSetting, hisTreeNodes);
                hisSearchTreeNodeByName(txtSearch);
            } else {
                var type = 'warning';
                var msg = '未查询到树形组织数据';
...
function hisSearchTreeNodeByName(txtSearch) {
    var zTree = $.fn.zTree.getZTreeObj("tree");
    var nodeList = [];
...
function hisGetFontCss(treeId, treeNode) {
...
function hisTreeNodeHighLightClear() {
    var zTree = $.fn.zTree.getZTreeObj("tree");
    var nodeList = [];
