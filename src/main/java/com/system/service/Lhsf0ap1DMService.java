...
public interface Lhsf0ap1DMService {
    /**
     * 获取设备数据-管理员权限
     * @param ORGId 组织ID
     * @return
     * @throws Exception
     */
    List<Lhsf0ap1DM> selectByORGId(String ORGId) throws Exception;
     ...
     * @throws Exception
     */
    List<Lhsf0ap1DM> selectByORGIdAndRoleId(String ORGId, List<RoleInfo> roleInfoList) throws Exception;
     ...
     * @throws Exception
     */
    Lhsf0ap1DM selectByDeviceId(String sDeviceId) throws Exception;
     ...
     * @throws Exception
     */
    List<Lhsf0ap1DMHis> selectByDevNumAndDate(String sDeviceId, String sStartDate, String sEndDate) throws Exception;
     ...
     * @return excel 文件
     */
    File exportStorage(List<Lhsf0ap1DM> storageList);
     ...
     * @return excel 文件
     */
    File exportStorageHis(List<Lhsf0ap1DMHis> storageList);
}
