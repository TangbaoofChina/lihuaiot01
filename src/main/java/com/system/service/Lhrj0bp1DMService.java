 ...
 * 食品公司冷库测温
 */
public interface Lhrj0bp1DMService {
    /**
     * 获取设备数据-管理员权限
     * @param ORGId 组织ID
     * @return
     * @throws Exception
     */
    List<Lhrj0bp1DM> selectByORGId(String ORGId) throws Exception;
     ...
     * @throws Exception
     */
    List<Lhrj0bp1DM> selectByORGIdAndRoleId(String ORGId, List<RoleInfo> roleInfoList) throws Exception;
     ...
     * @throws Exception
     */
    Lhrj0bp1DM selectByDeviceId(String sDeviceId) throws Exception;
     ...
     * @throws Exception
     */
    List<Lhrj0bp1DM> selectByDevNumAndDate(String sDeviceId, String sStartDate, String sEndDate) throws Exception;
     ...
     * @return excel 文件
     */
    File exportStorage(List<Lhrj0bp1DM> storageList);

    /*******************曲线部分 Start*******************************************/
    //根据查询参数生成;
    Map<String,List<Lhrj0bp1DMHis>> selectHisByDateAndIDs(String[] sDeviceIds, String sQueryParam, String sStartDate, String sEndDate) throws Exception;
    /*******************曲线部分 End*******************************************/
}
