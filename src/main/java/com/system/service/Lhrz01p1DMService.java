 ...
 * 食品公司GPS测温
 */
public interface Lhrz01p1DMService {
    /**
     * 获取设备数据-管理员权限
     * @param ORGId 组织ID
     * @return
     * @throws Exception
     */
    List<Lhrz01p1DM> selectByORGId(String ORGId) throws Exception;
     ...
     * @throws Exception
     */
    List<Lhrz01p1DM> selectByORGIdAndRoleId(String ORGId, List<RoleInfo> roleInfoList) throws Exception;
     ...
     * @throws Exception
     */
    Lhrz01p1DM selectByDeviceId(String sDeviceId) throws Exception;
     ...
     * @throws Exception
     */
    List<Lhrz01p1DM> selectByDevNumAndDate(String sDeviceId, String sStartDate, String sEndDate) throws Exception;
     ...
     * @return excel 文件
     */
    File exportStorage(List<Lhrz01p1DM> storageList);

    /*******************曲线部分 Start*******************************************/
    //根据查询参数生成;
    Map<String,List<Lhrz01p1DMHis>> selectHisByDateAndIDs(String[] sDeviceIds, String sQueryParam, String sStartDate, String sEndDate) throws Exception;
    /*******************曲线部分 End*******************************************/
}
