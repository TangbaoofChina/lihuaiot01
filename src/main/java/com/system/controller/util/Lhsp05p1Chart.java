 ...
 **/
@Controller
public class Lhsp05p1Chart {
    //生成曲线
    public PhoneEChartsOptions getECharts(String sQueryParam, Map<String, String> deviceInfoMap, Map<String, List<Lhsp05p1DMHis>> dmMapByDate) {
    ...
    //生成温度01曲线
    private PhoneEChartsOptions getTemp01Charts(Map<String, String> deviceInfoMap, Map<String, List<Lhsp05p1DMHis>> dmMapByDate) {
        ...
        List<String> sDateList = Lhsp05p1Util.getDate01List(dmMapByDate);
    ...
    //生成温度02曲线
    private PhoneEChartsOptions getTemp02Charts(Map<String, String> deviceInfoMap, Map<String, List<Lhsp05p1DMHis>> dmMapByDate) {
        PhoneEChartsOptions phoneEChartsOptions = new PhoneEChartsOptions();
        phoneEChartsOptions.setColor(EChartsUtil.Color());
    ...
    //生成温度03曲线
    private PhoneEChartsOptions getTemp03Charts(Map<String, String> deviceInfoMap, Map<String, List<Lhsp05p1DMHis>> dmMapByDate) {
        PhoneEChartsOptions phoneEChartsOptions = new PhoneEChartsOptions();
        phoneEChartsOptions.setColor(EChartsUtil.Color());
    ...
    //生成温度04曲线
    private PhoneEChartsOptions getTemp04Charts(Map<String, String> deviceInfoMap, Map<String, List<Lhsp05p1DMHis>> dmMapByDate) {
        PhoneEChartsOptions phoneEChartsOptions = new PhoneEChartsOptions();
        phoneEChartsOptions.setColor(EChartsUtil.Color());
    ...
    /********************温度01曲线私有函数 开始****************************/
    //获取温度的曲线
    private List<ParameterData> getTemp01Series(Map<String, String> deviceInfoMap, Map<String, List<Lhsp05p1DMHis>> dmMapByDate) {
        List<ParameterData> parameterDataList = new ArrayList<>();
        if (dmMapByDate.size() < 1) {
            return parameterDataList;
        }
        for (Map.Entry<String, List<Lhsp05p1DMHis>> entry : dmMapByDate.entrySet()) {
            ParameterData parameterData = new ParameterData();
            String parameterName = deviceInfoMap.get(entry.getKey()) + "-温度01(℃)";
            parameterData.setName(parameterName);
            List<Lhsp05p1DMHis> value = entry.getValue();
    ...
    //获取温度的最小值
    private String getMinTemp01(Map<String, List<Lhsp05p1DMHis>> dmMapByDate) {
        //遍历map中的值
        float minValue = 100;
        //取出第一个值，防止默认值0最小
        for (List<Lhsp05p1DMHis> value : dmMapByDate.values()) {
...
//        }
    ...
    //获取温度的最大值
    private String getMaxTemp01(Map<String, List<Lhsp05p1DMHis>> dmMapByDate) {
        //遍历map中的值
    ...
    /********************温度02曲线私有函数 开始****************************/
    //获取温度的曲线
    private List<ParameterData> getTemp02Series(Map<String, String> deviceInfoMap, Map<String, List<Lhsp05p1DMHis>> dmMapByDate) {
        List<ParameterData> parameterDataList = new ArrayList<>();
        if (dmMapByDate.size() < 1) {
            return parameterDataList;
        }
    ...
    //获取温度的最小值
    private String getMinTemp02(Map<String, List<Lhsp05p1DMHis>> dmMapByDate) {
        //遍历map中的值
        float minValue = 100;
        //取出第一个值，防止默认值0最小
        for (List<Lhsp05p1DMHis> value : dmMapByDate.values()) {
...
//        }
    ...
    //获取温度的最大值
    private String getMaxTemp02(Map<String, List<Lhsp05p1DMHis>> dmMapByDate) {
        //遍历map中的值
        float maxValue = -100; //这里不需要取出第一个值
        for (List<Lhsp05p1DMHis> value : dmMapByDate.values()) {
            for (int i = 0; i < value.size(); i++) {
    ...
    /********************温度03曲线私有函数 开始****************************/
    //获取温度的曲线
    private List<ParameterData> getTemp03Series(Map<String, String> deviceInfoMap, Map<String, List<Lhsp05p1DMHis>> dmMapByDate) {
        List<ParameterData> parameterDataList = new ArrayList<>();
        if (dmMapByDate.size() < 1) {
            return parameterDataList;
        }
    ...
    //获取温度的最小值
    private String getMinTemp03(Map<String, List<Lhsp05p1DMHis>> dmMapByDate) {
        //遍历map中的值
        float minValue = 100;
        //取出第一个值，防止默认值0最小
        for (List<Lhsp05p1DMHis> value : dmMapByDate.values()) {
...
//        }
    ...
    //获取温度的最大值
    private String getMaxTemp03(Map<String, List<Lhsp05p1DMHis>> dmMapByDate) {
        //遍历map中的值
        float maxValue = -100; //这里不需要取出第一个值
        for (List<Lhsp05p1DMHis> value : dmMapByDate.values()) {
            for (int i = 0; i < value.size(); i++) {
    ...
    /********************温度04曲线私有函数 开始****************************/
    //获取温度的曲线
    private List<ParameterData> getTemp04Series(Map<String, String> deviceInfoMap, Map<String, List<Lhsp05p1DMHis>> dmMapByDate) {
        List<ParameterData> parameterDataList = new ArrayList<>();
        if (dmMapByDate.size() < 1) {
            return parameterDataList;
        }
    ...
    //获取温度的最小值
    private String getMinTemp04(Map<String, List<Lhsp05p1DMHis>> dmMapByDate) {
        //遍历map中的值
        float minValue = 100;
        //取出第一个值，防止默认值0最小
        for (List<Lhsp05p1DMHis> value : dmMapByDate.values()) {
...
//        }
    ...
    //获取温度的最大值
    private String getMaxTemp04(Map<String, List<Lhsp05p1DMHis>> dmMapByDate) {
        //遍历map中的值
        float maxValue = -100; //这里不需要取出第一个值
        for (List<Lhsp05p1DMHis> value : dmMapByDate.values()) {
            for (int i = 0; i < value.size(); i++) {
