...
import com.system.controller.util.Lhfh05p1Chart;
...
public class Lhfh05p1HCDLController {
    @Autowired
    private DeviceInfoService deviceInfoService;
    @Autowired
    private Lhfh05p1DMService dmService;
    @Autowired
    private Lhfh05p1Chart dmChart;
    @Autowired
    private DeviceUtilController deviceUtilController;

    @RequestMapping(value = "selectDevicesLhfh05p1", method = {RequestMethod.POST}, produces = {"application/json;charset=UTF-8"})
    @ResponseBody
    public String selectDevicesLhfh05p1() throws Exception {
        String jsonString = "[]";
        //获取用户角色
    ...
    @RequestMapping(value = "/selectLhfh05p1ByIdsAndDateChart", method = RequestMethod.POST, produces = {"application/json;charset=UTF-8"})
    @ResponseBody
    public String selectLhfh05p1ByIdsAndDateChart(String[] sDeviceIds,
                                                  String sQueryParam,
                                                  String sStartDate,
    ...
    private String getOneParamChart(String[] sDeviceIds, String sQueryParam, String sStartDate, String sEndDate) throws Exception{
        Map<String, List<Lhfh05p1DMHis>> dmHisMapByDate = dmService.selectHisByDateAndIDs(sDeviceIds, sQueryParam, sStartDate, sEndDate);
