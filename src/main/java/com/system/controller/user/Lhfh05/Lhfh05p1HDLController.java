...
public class Lhfh05p1HDLController {
    @Autowired
    private Lhfh05p1DMService dmService;

    @RequestMapping(value = "selectLhfh05p1ByDevNumAndDateAndPaging", method = {RequestMethod.POST}, produces = {"application/json;charset=UTF-8"})
    @ResponseBody
    public String selectLhfh05p1ByDevNumAndDateAndPaging(Integer pageNumber,Integer pageSize,String sDeviceId,String sStartDate,String sEndDate) throws Exception {
        String jsonString = "[]";
        if (sDeviceId !=null) {
    ...
    @RequestMapping(value = "exportHisLhfh05p1DeviceList", method = RequestMethod.GET)
    public void exportHisLhfh05p1DeviceList(String sDeviceId,
                                            String sStartDate,
                                            String sEndDate,
                                            HttpServletRequest request,
                                            HttpServletResponse response) throws Exception {
        String fileName = "hisLhfh05p1devicelist.xlsx";
    ...
    @ResponseBody
    public String lhfh05p1DeviceHead() throws Exception{
