...
public class HisChartDLFeedC411Controller {
    ...
    public String selectFeedC411ParamsById(String devId) throws Exception {
        String jsonString = "[]";
        List<FC411TempNameRelation> sTNRs = feedC411DMService.selectParamsById(devId);
    ...
    public String selectFeedC411ByIdsAndDateChart(String[] sDeviceIds,
        ...
        String jsonString = "[]";
        List<FC411HisTemp> FC411HisTempList = feedC411DMService.selectTempByDeviceIdAndDate(sDeviceIds[0],sQueryParam01,sStartDate,sEndDate);
        PhoneEChartsOptions phoneEChartsOptions = feedC411Chart.getECharts(sQueryParam02, FC411HisTempList);
